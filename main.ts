...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    ...
    mySprite2 = sprites.create(img`
        ...
        . . . 2 2 4 4 4 4 4 2 2 2 . . . 
        `, SpriteKind.Explosion)
    mySprite2.setPosition(myDart.x, myDart.y)
    pause(500)
    sprites.destroy(mySprite2)
    mySprite2 = sprites.create(img`
        . . . . . . . . b b . . . . . . 
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    myDart.startEffect(effects.fire)
    myDart.setPosition(20 + mySprite.x, 0)
    myDart.setVelocity(0, 50)
    pause(2700)
...
game.onUpdateInterval(randint(2000, 5000), function () {
    otherSprite = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Enemy)
    otherSprite.setPosition(160, randint(1, 100))
...
game.onUpdateInterval(randint(2000, 5000), function () {
    mySprite3 = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.Enemy)
    mySprite3.setPosition(160, randint(1, 100))
